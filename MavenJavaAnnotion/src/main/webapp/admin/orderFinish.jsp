	...
	<div data-role="page" data-position="fixed">
		  ...
		  <div data-role="main" align="center" style="margin: 5px;"> 
				  ...
				  <div data-role="popup" id="myPopup" class="ui-content" style="min-width:250px;" data-dismissible="false">
				    <a href="#" onclick="closeDialog();" data-rel="back"  id="close" class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>
				      <form  id="ajaxForm">
				        <div>
				          <h3 align="center" >该工单已经完成！请选择是否取消通知！</h3>
				          ...
				          <button  data-inline="true" value="cancel"  id="cancel" name="cancel">取消通知</button>	
