...
<script type="text/javascript">
 	...
 	function formatBlogTitle(val,row){   //val是一个对象
 		if(val==null){
 	...
 	function deleteComment(){
 			...
 			var ids=strIds.join(","); /// 2，1，3，5，6，7
...
<table id="dg" title="评论管理管理" class="easyui-datagrid" 
  fitColumns="true" pagination="true" rownumbers="true" toolbar="#tb"
  ...
  <thead>
  	<tr>
  		...
  		<th field="state" width="50" align="center" formatter="formatterCommentState">审核状态</th>
  	</tr>
  </thead>
</table>
<div id="tb">
	<div>
		<a href="javascript:deleteComment();" class="easyui-linkbutton" iconCls="icon-cancel" plain="true">删除评论</a>
	</div>
</div>
</body>
</html>