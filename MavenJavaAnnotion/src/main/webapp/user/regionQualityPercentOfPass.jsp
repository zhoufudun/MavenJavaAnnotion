            ...
            function (ec) {
                ...
                var option = {
                	    ...
                	    legend: {
                	        orient : 'vertical',
                	        x : 'left',
                	        data:['${region}区合格数量','${region}区次品数量']
                	    },
                	    toolbox: {
                	        show : true,
                	        feature : {
                	    ...
                	    series : [
                	        {
                	            ...
                	            data:[
                	                {value:${totalPercentOfPassNumber}, name:'${region}区合格数量'},
                	                {value:${totalDefectiveNumber}, name:'${region}区次品数量'}
                	            ]
                	        }
                	    ]
                	};       
...
<body>
	<div data-role="page">
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="330" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
					<tr>
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:315px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">${region}区产品合格率</div>	
								</div>
					...
					<tr style="height:35px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">${region}区制品合格率</label>	
								<label id="label4"  style="float:right;font-size:16px;">${regionQualityPercentOfPass}%</label>			
							</div>
						</td>
					</tr>																						
				</table>				
