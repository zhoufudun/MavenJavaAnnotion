                	    ...
                	    series: [{
                            ...
                            axisLine: {            // 坐标轴线  
                                     lineStyle: {       // 属性lineStyle控制线条样式  
                                         color: [[0.03, '#91c7ae'], [0.06, '#63869e'], [1, 'red']]
                                                }  
                                            },      
                	        data: [{
                	            value: ${totalQualityLost},
                	            name: '总体质量损失率'
                	        }]
                	    }]
                };      
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:320px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总体质量损失率</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总损失质量</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								...
								<c:choose>
									<c:when test="${totalQualityLost>=6.0}">
										<label id="label1"  style="float:right; font-size:16px;"><font color="red">质量损失较高</font></label>	
									</c:when>
									<c:when test="${totalQualityLost<6.0 && totalQualityLost>=3.0}">
