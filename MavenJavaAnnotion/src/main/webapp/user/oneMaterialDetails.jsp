...
<body>
	<div data-role="page">
		  ...
		  <div data-role="header"  data-position="fixed">
		    <a href="${pageContext.request.contextPath}/material/totalMaterialSituation.do" rel="external" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
    			<h1>材料详情</h1>
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:320px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">材料详情</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">材料状态</label>	
								<label id="label2"  style="float:right;font-size:16px;">
									<c:if test="${material.status==1}">
										<font color="green">材料充足</font>
									</c:if>
									<c:if test="${material.status==2}">
										<font color="blue">材料轻微不足</font>
									</c:if>
									<c:if test="${material.status==3}">
										<font color="red">材料严重不足</font>
									</c:if>									
								</label>	
							</div>
						</td>
					...
					<tr style="height:38px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">剩余材料/材料上线</label>	
								<label id="label4"  style="float:right;font-size:16px;">${material.weight}(g)/${material.hopeWeight}(g)</label>			
							</div>
						</td>
					</tr>													
