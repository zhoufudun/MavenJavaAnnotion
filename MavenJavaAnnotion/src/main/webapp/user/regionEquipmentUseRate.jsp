...
/*		////
   ...
   /*     //第一个图标刷新
    	...
    	*/
    	//////////////////////////////
   		function search(){
			window.location.href="${pageContext.request.contextPath}/machine/regionOneMacNumUsingSituation.do?id="+$('#id option:selected').val();
	    }
    	function regionCoreMacNum(region){
			window.location.href="${pageContext.request.contextPath}/machine/regionCoreMacNumUsingSituation.do?region="+region;
    	}
</script>
<style type="text/css">
	#pie{
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:330px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">${region}区设备运行情况</div>	
					...
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  style="width:358px" ><a href="#oneMacNum" style="text-decoration: none;" data-rel="popup" data-position-to="window"  align="center" >该区某设备运行情况</a></button>							
						</td>
					</tr>
					
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  style="width:358px" ><a style="text-decoration: none;" data-rel="popup" data-position-to="window"  align="center" onclick="regionCoreMacNum(${region});">${region}区核心设备运行情况</a></button>							
						</td>
					</tr>
				</table>
				<!--某机器使用情况查询-->		  				
