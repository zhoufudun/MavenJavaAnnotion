                	    ...
                	    series : [ 
                	        {
                	            ...
                	            center: ['50%', '60%'],
                	            data:[
                	                {value:'${totalFinishNumber}', name:'总体设备工单合格数'},
                	                {value:'${totalDefectiveNumber}', name:'总体设备工单不合格数'}             	               
                	            ]
                	        }
                	    ]
                	};
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div style="height:350px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总体设备合格率情况</div>	
					...
					<tr  style="height:30px;margin-top:-5px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总体设备合格率</label>	
