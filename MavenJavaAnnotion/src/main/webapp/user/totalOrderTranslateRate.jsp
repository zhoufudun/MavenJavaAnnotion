                	    ...
                	    series: [{
                            ...
                            axisLine: {            // 坐标轴线  
                                     lineStyle: {       // 属性lineStyle控制线条样式  
                                         color: [[0.94, '#c23531'], [0.97, '#63869e'], [1, '#91c7ae']]
                                                }  
                                            },      
                	        data: [{
                	            value: ${totalOrderTranslateRate},
                	            name: '总体产品转换率'
                	        }]
                	    }]
                };      
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="200" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:320px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总体产品转化率</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总消耗制品质量</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总需要制品质量</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">产品转换率状态</label>	
								<c:choose>
									<c:when test="${totalOrderTranslateRate>=97.0}">
										<label id="label1"  style="float:right; font-size:16px;"><font color="green">产品转换率正常</font></label>	
									</c:when>
									<c:when test="${totalOrderTranslateRate<97.0&&totalOrderTranslateRate>=94.0}">
