...
/*		////
                        ...
                        series : [
                            {
                                "name":"",
                                "type":"bar",
                                "data":['${regionDrawBack}','${totalBreakDown}']
                            }
                        ]
                    };        
                // 为echarts对象加载数据 
   ...
   /*     //第一个图标刷新
    	...
    	*/
    	//////////////////////////////
   		function searchRegionOneMacNumDrawBack(){
			window.location.href="${pageContext.request.contextPath}/machine/regionOneMacNumDrawBack.do?id="+$('#regionOneMacNumDrawBack option:selected').val();
	    }
    	function regionCoreMacNum(region){
			window.location.href="${pageContext.request.contextPath}/machine/regionCoreMacNumDrawBack.do?region="+region;
    	}
</script>
<style type="text/css">
	#pie{
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:330px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">${region}区设备故障情况</div>	
					...
					<tr  style="height:48px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">${region}区设备故障比率</label>	
								<label id="label2"  style="float:right;font-size:16px;">${regionDrawBack}/${totalBreakDown}</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:48px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">${region}区核心设备台数</label>	
								<label id="label2"  style="float:right;font-size:16px;">${regionMacNumList.size()}</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:48px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总设备台数</label>	
								<label id="label2"  style="float:right;font-size:16px;">${macNumList.size()}</label>	
							</div>
						</td>
					</tr>									
					...
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  style="width:358px" ><a href="#regionOneMacNumDrawBack" style="text-decoration: none;" data-rel="popup" data-position-to="window"  align="center" >${region}区某设备故障情况</a></button>							
						</td>
					</tr>
					
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  style="width:358px" ><a style="text-decoration: none;" data-rel="popup" data-position-to="window"  align="center" onclick="regionCoreMacNum(${region});">${region}区核心设备故障情况</a></button>							
						</td>
					</tr>
				</table>
				<!--该区某机器故障查询-->		  				
				<div data-role="popup" id="regionOneMacNumDrawBack" class="ui-content" style="min-width:250px;">
				     <a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>			     
				        <div>
					          <h3 align="center">请选择机器</h3>					          
					          <label for="regionOneMacNumDrawBack"  class="ui-hidden-accessible" >id:</label> 
					          <select id="regionOneMacNumDrawBack" name="regionOneMacNumDrawBack">
					            <c:forEach items="${regionMacNumList}" var="macNum">
					            	<option value="${macNum.id}">${macNum.factory}-${macNum.code}</option>
					            </c:forEach>					          						          	
					          </select>		          					          
					          <button onclick="searchRegionOneMacNumDrawBack();" >搜索</button> 				          		          
				        </div>
				</div>
		  </div>	
