                	    ...
                	    series : [
                	        {
                	            ...
                	            data:[
                	                {value:${totalOrderNoYield}, name:'不合格率'},
                	                {value:${totalOrderYield}, name:'合格率'}             	                
                	            ]
                	        },
                    	    ...
                    	    series : [
                    	        {
                    	            ...
                    	            data:[{value: ${orderStatisticRate}, name: '工单统计率'}]
                    	        }
                    	    ]
                    	};      
                    // 为echarts对象加载数据 
...
<body>
	<div data-role="page">
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="580" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
					<tr>
						<td bgcolor="#F6F6F6" align="center" >
							<div style="height:470px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									<div style="float:left; padding-left:15px;"><img src="${pageContext.request.contextPath}/static/images/15.png"></div>	
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总工单合格率</div>	
								</div><hr style="border:solid 1px #F6F6F6">
								<div id="first" style="height:200px; width:95%; margin-top:0px;" >
									
								</div>	
						        <hr style="border:solid 1px #F6F6F6;margin-top:-30px;">
								<div id="second" style="height:270px; width:95%; margin-top:-30px;" >
					...
					<tr  style="height:30px;margin-top:-5px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总体工单个数</label>	
								<label id="label2"  style="float:right;font-size:16px;">${totalSize}个</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:30px;margin-top:-5px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">统计工单个数</label>	
								<label id="label2"  style="float:right;font-size:16px;">${size}个</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:30px;margin-top:-5px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">统计不合格数量</label>	
								<label id="label2"  style="float:right;font-size:16px;">${totalDefectiveNumber}个</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:30px;margin-top:-5px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">统计合格数量</label>	
								<label id="label2"  style="float:right;font-size:16px;">${totalFinishNumber-totalDefectiveNumber}个</label>	
							</div>
						</td>
					</tr>
