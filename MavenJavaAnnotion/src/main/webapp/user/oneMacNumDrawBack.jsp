                	    ...
                	    series : [
                	        {
                	            ...
                	            data:[
                	                {value:${macNum.breakDownNumber}, name:'该机故障次数'},
                	                {value:${totalBreakDown}, name:'其他机器故障次数'}
                	            ]
                	        }
                	    ]
                	};       
...
<body>
	<div data-role="page">
		  ...
		  <div data-role="header"  data-position="fixed">
		    <a href="${pageContext.request.contextPath}/machine/totalEquipmentDrawBackRate.do" rel="external" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
    			<h1>设备故障详情</h1>
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:315px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">某设备故障详情</div>	
					...
					<tr style="height:30px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">该机器故障次数</label>	
								<label id="label4"  style="float:right;font-size:16px;">${macNum.breakDownNumber}次</label>			
							</div>
						</td>
					</tr>
					...
					<tr style="height:30px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">车间总故障次数</label>	
								<label id="label4"  style="float:right;font-size:16px;">${totalBreakDown+macNum.breakDownNumber}次</label>			
							</div>
						</td>
					</tr>
