		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:315px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总人力资源详情</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">利用率</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">空闲率</label>	
					...
					<tr style="height:38px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">请假率</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">离职率</label>	
					...
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<a href="#oneEmployees" data-rel="popup" data-position-to="window" class="" align="center" ><img src="${pageContext.request.contextPath}/static/images/49.png" style="width:354px;height:55px;" id="Equipment-HouseKeeper-images"></a>								
						</td>
					</tr>
					
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  value="登录" style="width:354px" onclick="javascript:window.location.href='${pageContext.request.contextPath}/employees/coreEmployeesUseRates.do'">核心员工利情况</button>									
						</td>
					</tr>
					
				</table>
				<!--员工状态查询-->		  				
				<div data-role="popup" id="oneEmployees" class="ui-content" style="min-width:250px;">
				     <a href="#" onclick="closeSelectOrderNumber();" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn ui-icon-delete ui-btn-icon-notext ui-btn-right">关闭</a>
				     <form method="post" action="${pageContext.request.contextPath}/employees/getEmployeesById.do"  >
				        <div>
					          <h3 align="center">请选择员工编号</h3>					          
					          <label for="id"  class="ui-hidden-accessible" >id:</label>   <!--员工id-->  
					          <select id="id" name="id" onblur="checkEmployeesId();" >
