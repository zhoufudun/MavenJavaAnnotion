...
/*		////
   ...
   /*     //第一个图标刷新
    	...
    	*/
    	//////////////////////////////
   		function search(){
			window.location.href="${pageContext.request.contextPath}/machine/oneMacNumUsingAnalysis.do?id="+$('#id option:selected').val();
	    }
</script>
<style type="text/css">
	#pie{
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:330px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总设备利用比率详情</div>	
					...
					<tr  style="height:48px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">总设备运行率</label>	
								<label id="label2"  style="float:right;font-size:16px;">${usingRate}%</label>	
							</div>
						</td>
					</tr>
