                	    ...
                	    series : [
                	        {
                	            ...
                	            axisLine: {            // 坐标轴线
                	                ...
                	                lineStyle: {       // 属性lineStyle控制线条样式
                	                    color: [[0.94, 'red'],[0.97, 'skyblue'],[1, 'lightgreen']], 
                	                    width: 30
                	                }
                	            },
                	            axisTick: {            // 坐标轴小标记
                	            ...
                	            data:[{value: ${regionQualityTranslateRate}, name: '${region}区产品转化率'}]
                	        }
                	    ]
                	};      
                // 为echarts对象加载数据 
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="200" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:320px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">${region}区产品转化率</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">${region}区总消耗制品质量</label>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">${region}区总需要制品质量</label>	
								<label id="label2"  style="float:right;font-size:16px;">${totalNeedQuality}</label>	
							</div>
						</td>
					</tr>													
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">${region}区产品转换率状态</label>	
								<c:choose>
									<c:when test="${regionQualityTranslateRate>=97.0}">
										<label id="label1"  style="float:right; font-size:16px;"><font color="green">产品转换率正常</font></label>	
									</c:when>
									<c:when test="${regionQualityTranslateRate<97.0&&regionQualityTranslateRate>=94.0}">
										<label id="label1"  style="float:right; font-size:16px;"><font color="lightblue">产品转换率较低</font></label>	
									</c:when>
									<c:otherwise>
										<label id="label1"  style="float:right; font-size:16px;"><font color="red">产品转换率过低</font></label>	
						            </c:otherwise>
								</c:choose>							
							</div>
						</td>
