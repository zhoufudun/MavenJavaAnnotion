...
/*		////
                	    ...
                	    series: [
                	        {
                	            ...
                	            data: ['${coreEquipmentDrawBack}','${totalEquipmentDrawBack}'],
                	            markPoint: {
                	                tooltip: {
                	                    trigger: 'item',
                	                ...
                	                data: [
                	                    {xAxis:0, y: 350, name:'核心设备故障次数', symbolSize:16},
   ...
   /*     //第一个图标刷新
    	...
    	*/
    	//////////////////////////////
   		function search(){
			window.location.href="${pageContext.request.contextPath}/machine/coreOneMacNumDrawBack.do?id="+$('#id option:selected').val();
	    }
</script>
<style type="text/css">
	#pie{
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:330px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">核心设备故障情况</div>	
					...
					<tr  style="height:48px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">核心设备故障率</label>	
								<label id="label2"  style="float:right;font-size:16px;">${coreDrawBackRate}</label>	
							</div>
						</td>
					</tr>
					...
					<tr style="height:38px;border:1px solid red">
						<td align="center">
							<button  style="width:358px" ><a href="#oneMacNumDrawBack" style="text-decoration: none;" data-rel="popup" data-position-to="window"  align="center" >某核心机器故障情况</a></button>							
						</td>
					</tr>
