                	    ...
                	    series: [
                	        {
                	            ...
                	            data: ['${macNum.breakDownNumber}','${totalBreakDown}'],
                	            markPoint: {
                	                tooltip: {
                	                    trigger: 'item',
                	                ...
                	                data: [
                	                    {xAxis:0, y: 350, name:'该核心设备故障次数', symbolSize:16},
                	                    {xAxis:1, y: 350, name:'总体设备故障次数', symbolSize:16}
                	                ]
                	            }
                	        }
                	    ]
...
<body>
	<div data-role="page">
		  ...
		  <div data-role="header"  data-position="fixed">
		    <a href="${pageContext.request.contextPath}/machine/coreEquipmentDrawBackRate.do" rel="external" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
    			<h1>设备故障详情</h1>
					...
					<tr style="height:30px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">该核心设备故障率</label>	
								<label id="label4"  style="float:right;font-size:16px;">${coreOneMacNumDrawBackRate}</label>			
							</div>
						</td>
					</tr>
