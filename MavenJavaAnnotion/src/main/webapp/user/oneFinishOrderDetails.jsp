                	    ...
                	    series: [{
                            ...
                            axisLine: {            // 坐标轴线  
                                     lineStyle: {       // 属性lineStyle控制线条样式  
                                         color: [[0.2, '#c23531'], [0.4, '#63869e'], [1, '#91c7ae']]
                                                }  
                                            },      
                	        data: [{
                	            value:${passRate},
...
<body>
	<div data-role="page">
		  ...
		  <div data-role="header"  data-position="fixed">
		    <a href="${pageContext.request.contextPath}/order/orderFinishAttention.do" rel="external" data-role="button" data-icon="arrow-l" data-iconpos="notext"></a>
    			<h1>订单详情</h1>
		  ...
		  <div data-role="content" align="center">
			   ...
			   <tr>
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:480px; border:solid 1px black; width:94%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									<div style="float:left; padding-left:15px;"><img src="${pageContext.request.contextPath}/static/images/15.png"></div>	
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">订单详情</div>	
								</div><hr style="border:solid 1px #F6F6F6">
								<div id="first" style="height:240px; width:95%; margin-top:-30px;" >
									<!--仪表盘-->
								</div>	
								<hr>
								<div id="second" style="height:240px; width:95%; margin-top:-30px;" >
									<!--仪表盘-->
								</div>		
							</div>
						</td>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">计划产量</label>	
								<label id="label2"  style="float:right;font-size:16px;">${addOrder.number}个</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">实际产量</label>	
								<label id="label2"  style="float:right;font-size:16px;">${addOrder.finishNumber}个</label>	
							</div>
						</td>
					</tr>
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">次品数</label>	
								<label id="label2"  style="float:right;font-size:16px;">${addOrder.xDefectiveNum+addOrder.yDefectiveNum+addOrder.zDefectiveNum}个</label>	
							</div>
						</td>
					</tr>																		
