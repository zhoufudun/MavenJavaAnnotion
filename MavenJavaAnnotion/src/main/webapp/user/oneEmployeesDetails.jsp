		  ...
		  <div data-role="content" align="center">
			...
			<!-- <tr>
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">员工状态</label>	
								<label id="label2"  style="float:right;font-size:16px;">
									<c:if test="${employees.status==1}">
										<font color="gray">空闲中</font>
									</c:if>
									<c:if test="${employees.status==2}">
										<font color="green">工作中</font>
									</c:if>
									<c:if test="${employees.status==4}">
										<font color="red">已离职</font>
									</c:if>
									<c:if test="${employees.status==3}">
										<font color="blue">请假中</font>
									</c:if>
								</label>	
							</div>
						</td>
					...
					<tr style="height:38px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">员工姓名</label>	
								<label id="label4"  style="float:right;font-size:16px;">${employees.name}</label>			
							</div>
						</td>
					</tr>
					...
					<tr style="height:38px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">所在部门</label>	
								<label id="label4"  style="float:right;font-size:16px;">${employees.part}</label>			
							</div>
						</td>
					</tr>	
					...
					<tr style="height:38px;border:1px solid black;">
						<td align="center" >
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">所在工位</label>	
								<label id="label4"  style="float:right;font-size:16px;">${employees.position}</label>			
							</div>
						</td>
					</tr>				
