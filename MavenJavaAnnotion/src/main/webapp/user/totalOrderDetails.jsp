					...
					series : [
						{
							...
							data:[
								 {name:"总计划生产量",value:'${totalPlanNumber}'},
							     {name:"总实际生产量",value:'${totalFinishNumber}'}
							   ]
						}
					]
				};
		  ...
		  <div data-role="content" align="center">
		  		<table  width="100%" height="500" align="center" border="0" cellpadding="0" cellspacing="2" style="border-radius:0px;">
						...
						<td bgcolor="#F6F6F6" align="center" >
							<div  style="height:320px; border:solid 1px white; width:95%;border-radius:8px 8px 8px 8px; background-color:white;">	
								<div style="height:20px;">
									...
									<div style="font-size:16px;font-weight:bold;float:left;margin-top:3px;">总工单详情</div>	
					...
					<tr  style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4px; background-color:white;">	
								<label id="label1"  style="float:left; font-size:16px;">执行率</label>	
								<label id="label2"  style="float:right;font-size:16px;">${executingAddOrderCount}/${totalAddOrderCount}</label>	
							</div>
						</td>
					</tr>
					...
					<tr style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">未派工率</label>	
								<label id="label4"  style="float:right;font-size:16px;">${unDispatchAddOrderCount}/${totalAddOrderCount}</label>			
							</div>
						</td>
					</tr>
					...
					<tr style="height:40px;">
						<td align="center">
							<div  style="height:30px; border:solid 1px white; width:95%;border-radius:4px 4px 4px 4pxs; background-color:white;">	
								<label id="label3"  style="float:left; font-size:16px;">订单完成率</label>	
								<label id="label4"  style="float:right;font-size:16px;">${finishAddOrderCount}/${totalAddOrderCount}</label>			
							</div>
						</td>
					</tr>	
				...
				<div data-role="popup" id="order-Execution" class="ui-content" style="min-width:250px;">
				     ...
				     <form method="post" action="${pageContext.request.contextPath}/totalWorkDetail/getOrderExecuStuById.do"  >
				        <div>
					          <h3 align="center">请选择工单编号</h3>					          
					          <label for="selectId"  class="ui-hidden-accessible" >工单:</label>   <!--工单id-->  
					          <select id="selectId" name="selectId" onblur="checkMacNum();" >
					          	<option value="-1">请选择工单...</option>
					          	<c:forEach items="${addOrderList}" var="addOrder" >
					          		<option value="${addOrder.id}">${addOrder.orderNumber}</option>
					          	</c:forEach>
					          </select>		          					          
